  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empowering Efficiency with HR Management System: Streamlining Employee Data, Payroll, Time Tracking, and Performance Evaluations in One Central Hub."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Efficiency with HR Management System: Streamlining Employee Data, Payroll, Time Tracking, and Performance Evaluations in One Central Hub.`}
            </Text>
            <Box
